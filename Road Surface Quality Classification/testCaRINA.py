...
while cv.waitKey(1) < 0:
    ...
    cv.rectangle(finalimg, (0*4, 0*4), (145*4, 80*4), (255, 255, 255), cv.FILLED)
    cv.putText(finalimg, 'Class: ', (5*4,15*4), cv.FONT_HERSHEY_SIMPLEX, 0.5*4, (0,0,0), 2)
    cv.putText(finalimg, label, (70*4,15*4), cv.FONT_HERSHEY_SIMPLEX, 0.5*4, color, 2)
    cv.putText(finalimg, prob, (5*4,35*4), cv.FONT_HERSHEY_SIMPLEX, 0.5*4, (0,0,0), 2)
    cv.putText(finalimg, 'Quality: ', (5*4,55*4), cv.FONT_HERSHEY_SIMPLEX, 0.5*4, (0,0,0), 2)
    cv.putText(finalimg, quality, (70*4,55*4), cv.FONT_HERSHEY_SIMPLEX, 0.5*4, colorQ, 2)
    cv.putText(finalimg, probQ, (5*4,75*4), cv.FONT_HERSHEY_SIMPLEX, 0.5*4, (0,0,0), 2)
